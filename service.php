...
<div class="wrapper_content">
  ...
  <div class="post_type_info">
		<?php
		$gls_unserial=$GLOBALS['gls_service'];
    ...
    <div id="options">
      <ul  id="filters" class="info_filters">
        <?php	$taxo = 'brochures'; $results = get_terms($taxo); if(count($results) > 1){ ?>
        <li>
   ...
   <?php 
    ...
    <div style="width:<?php echo $themeshock_gls_box_wdth; ?>" class="taxonomy_item <?php echo $cats;?>">
      <h2 class="contentTitle" style="font-family:<?php echo ($themeshock_gls_title_font_style!='')?$themeshock_gls_title_font_style:'Wire One'; ?> ;font-size: <?php echo $themeshock_gls_title_font_size; ?> ;"><?php the_title();?></h2>
