...
<div class="wrapper_content">
  ...
  <div id="content" <?php echo($fontColorPostType  != '')?'style="color: '.$fontColorPostType.'"':NULL?>>
      ...
      <?php
	        $gls_unserial=$GLOBALS['gls_portfolio'];
    ...
    <ul  id="filters" class="info_filters">
    	<?php	$taxo = 'portfolios'; $results = get_terms($taxo); if(count($results) > 1){ ?>
      <li>
    ...
    <div style="width:<?php echo $themeshock_gls_box_wdth; ?>" class="taxonomy_item <?php echo $cats?>">
      ...
      <h4><a href="<?php echo $GLOBALS['post_type_options']['website_url']; ?>" style="cursor:pointer;font-family:'<?php echo ($themeshock_gls_btn_fnt_stl)?$themeshock_gls_btn_fnt_stl:'Wire One'; ?>',sans-serif;font-size:<?php echo $themeshock_gls_btn_fnt_sz; ?>;" class="btn <?php echo ($themeshock_gls_btn_clr)?$themeshock_gls_btn_clr:''; ?>"><?php echo ($themeshock_gls_btn_txt!='')? $themeshock_gls_btn_txt : 'View Site'; ?></a></h4>
